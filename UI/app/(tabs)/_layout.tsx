...
function NativeTabLayout() {
  return (
    <NativeTabs>
      ...
      <NativeTabs.Trigger name="investigations">
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) => isIOS ? <SymbolView name="doc.text" tintColor={color} size={24} /> : <Feather name="file-text" size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="insights"
